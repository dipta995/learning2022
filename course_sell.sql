...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1448286298ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=course_sell&table=courses">`course_sell`.`courses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=course_sell&table=orders">`course_sell`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_blog&table=tbl_category">`db_blog`.`tbl_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop&table=tbl_customer">`pet_shop`.`tbl_customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop&table=tbl_comment">`pet_shop`.`tbl_comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop&table=tbl_cat">`pet_shop`.`tbl_cat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop&table=tbl_cart">`pet_shop`.`tbl_cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop&table=storage">`pet_shop`.`storage`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop&table=tbl_admin">`pet_shop`.`tbl_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_blog&table=tbl_post">`db_blog`.`tbl_post`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="457e5775275c25724775766a66236663">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pet_shop" targettable="tbl_admin">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_admin`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop" targettable="storage">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `storage`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop" targettable="tbl_cart">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_cart`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop" targettable="tbl_cat">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_cat`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop" targettable="tbl_comment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_comment`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop" targettable="tbl_customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_customer`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop" targettable="tbl_customer">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_customer`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_blog" targettable="tbl_category">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_category`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_blog" targettable="tbl_category">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_category`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="course_sell" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="course_sell" targettable="courses">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `courses`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="course_sell" targettable="orders">
                            <div class="action_content">
